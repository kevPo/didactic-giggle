            ...
            <div className="margin-left top-padding-small">
              <div class="middle-info">
                ...
                <ul className="column-container large-list bulleted-list">
                  <li><p>Elixir (this might be my love language)</p></li>
                  <li><p>F#</p></li>
                  ...
                  <ul className="company-list">
                    <li>
                      <div>
                        ...
                        <div>
                          <p className="role">Team lead and full stack engineer responsible for web application that enables customers to meet heavy compliance burdens.</p>
                          <ul className="bulleted-list">
                            ...
                            <li><p>Automated lengthy release process for team use Azure Pipelines.</p></li>
                          </ul>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div>
                        ...
                        <div>
                          <p className="role">Team lead and mentor at the Excella Extension Center (XC) at Virginia Tech. The XC combines student resources from Virginia Tech with consultants to provide high-quality, low-cost support for Excella’s clients.</p>
                          <ul className="bulleted-list">
                            <li><p><b>myUSCIS</b> - Responsible for the unauthenticated experience of the myUSCIS website (United States Citizenship and Immigration Services).</p></li>
                            <li><p><b>Ampathy.io</b> - Designed and developed prototype to help move customer interviews and marketing workflows from spreadsheets to an online tool.</p></li>
                            <li><p><b>eXplore</b> - Tech lead for internal staffing application used by Excella.</p></li>
                          </ul>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div>
                        ...
                        <div className="bulleted-list">
                          <p className="role">Developed and maintained web application for organizations needing to manage their compliance to various certifying and accrediting bodies.</p>
                          <ul className="bulleted-list">
                            <li><p>Evangelized and implemented total refactor of CSS architecture using SMACSS and SASS</p></li>
                            <li><p>Major contributor to open source tool, Huburn, that allowed team to monitor agile metrics.</p></li>
                            <li><p>Implemented "Health Check Model" to measure things about our team that agile metrics did not.</p></li>
                            <li><p>Keynote speaker at the 2017 Qualtrax User Conference and the 2017 A2LA Tech Forum.</p></li>
                          </ul>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div>
                        ...
                        <div className="bulleted-list">
                          <p className="role">Designed and developed new application for police officers to use in the field while also providing assistance modernizing legacy products responsible for public safety record management.</p>
                          <ul className="bulleted-list">
                            <li><p>Implemented real time collaboration for police officers using .NET SignalR.</p></li>
                            <li><p>Responsible for recording training videos and leading training sessions on how to use the software.</p></li>
                          </ul>
                        </div>
                      </div>
                    </li>
                    ...
                    <div>
                      ...
                      <div className="bulleted-list">
                        <p className="role">Built an Online Public Access Catalogue (OPAC) named Chamo. This tool was used in many libraries all over the world including the Hong Kong Public Library.</p>
                      </div>
                    </div>
                  </li>
                  </ul>
